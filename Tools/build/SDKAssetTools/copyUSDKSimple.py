...
#拷贝逻辑资源
copyUtil.copy_folder_contents('../SDKAsset/USDKSimple', '../../../UnityProject/Assets')
#拷贝package
copyUtil.copy_folder_contents('../SDKAsset/USDKPackage', '../../../UnityProject/Packages')

#修改manifest
manifest_path = '../../../UnityProject/Packages/manifest.json'
new_package = {
...
jsonUtil.add_unique_to_json_dict(manifest_path, "dependencies", new_package)

#修改static.asmdef
static_asmdef_path = '../../../UnityProject/Assets/Scripts/Runtime/Static/Custom.Static.asmdef'
new_asmdef = [
    "PeapodSDK.Module.Base",
    "PeapodSDK.Module.FirebaseVendor",
    "PeapodSDK.Module.AppsflyerVendor"
]
jsonUtil.add_multiple_to_json_array(static_asmdef_path, "references", new_asmdef)
