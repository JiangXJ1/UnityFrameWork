...
bool InputGeom::loadGeomSet(rcContext* ctx, const std::string& filepath)
{
	...
	while (src < srcEnd)
	{
		...
		else if (row[0] == 's')
		{
			...
			sscanf(row + 1, "%f %f %f %f %f %f %f %f %f %f %f %f %f %d %f\n",// %f %f %f %f %f %f %f",
...
void InputGeom::setSetting(const char* setting)
{
	m_hasBuildSettings = true;
	sscanf(setting, "%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%f",// %f %f %f %f %f %f %f",
		&m_buildSettings.cellSize,
		&m_buildSettings.cellHeight,
		&m_buildSettings.agentHeight,
		&m_buildSettings.agentRadius,
...
bool InputGeom::saveGeomSet(const BuildSettings* settings)
{
	...
	// Change extension
	std::string filepath = m_mesh->getInputFilePath();
	...
	// Store mesh filename.
	fprintf(fp, "f %s\n", m_mesh->getInputFilePath().c_str());

	// Store settings if any
	if (settings)
	{
		fprintf(fp,
			"s %f %f %f %f %f %f %f %f %f %f %f %f %f %d %f\n",// %f %f %f %f %f %f %f\n",
			settings->cellSize,
			settings->cellHeight,
